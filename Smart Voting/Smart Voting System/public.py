	...
	if 'submit' in request.form:
		...
		if len(res) > 0:
			...
			if res[0]['usertype']=="user":
				return redirect(url_for('public.otp'))
...
@public.route('/otp',methods=['get','post'])
def otp():
	# n=0
	if 'submit' in request.form:
		...
		# resetemail ='asishtbabu@gmail.com'
		email_sender = 'systemvoting7@gmail.com'
		...
		body = 'Greetings from Smart voting System, \n %d is the OTP to reset your password.' % (n)
		msg.attach(MIMEText(body, 'plain'))
		text = msg.as_string()
		connection = smtplib.SMTP('smtp.gmail.com', 587)
		connection.starttls()
		connection.login(email_sender, 'smartvotingsystem')
